...
INSERT INTO S_evenement.tblEvenement([nom],[dateDebut],[dateFin],[affiche],[url],[description],[dateSupprime]) VALUES('Festi-rire 2010','2010/01/02','2010/11/02',NULL,'https://jimdo.com/pulvinar/sed/nisl/nunc/rhoncus.json?dictumst=enim&morbi=sit&vestibulum=amet&velit=nunc&id=viverra&pretium=dapibus&iaculis=nulla&diam=suscipit&erat=ligula&fermentum=in&justo=lacus&nec=curabitur&condimentum=at&neque=ipsum&sapien=ac&placerat=tellus&ante=semper&nulla=interdum&justo=mauris&aliquam=ullamcorper&quis=purus&turpis=sit&eget=amet&elit=nulla&sodales=quisque&scelerisque=arcu&mauris=libero','Au-delà des questions géographiques, d’autres rivalités se situent dans le quotidien. Les célibataires VS les couples, qui est le plus heureux le soir de la St-Valentin? Les jeunes VS les vieux, l’énergie ou l’expérience?  ',NULL);
