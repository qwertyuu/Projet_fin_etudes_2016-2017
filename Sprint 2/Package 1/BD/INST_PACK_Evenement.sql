...
PRINT('DÉBUT DES INSERTIONS')

GO

PRINT('Début des insertion de la table des évènements')

GO

INSERT INTO S_evenement.tblEvenement([nom],[dateDebut],[dateFin],[affiche],[url],[description],[dateSupprime]) VALUES('Festi-rire 2010','2010/01/02','2010/11/02','http://www.futuroscopecongres.com/themes/front/assets/images/gallerry/home/diaporama2.jpg','https://jimdo.com/pulvinar/sed/nisl/nunc/rhoncus.json?dictumst=enim&morbi=sit&vestibulum=amet&velit=nunc&id=viverra&pretium=dapibus&iaculis=nulla&diam=suscipit&erat=ligula&fermentum=in&justo=lacus&nec=curabitur&condimentum=at&neque=ipsum&sapien=ac&placerat=tellus&ante=semper&nulla=interdum&justo=mauris&aliquam=ullamcorper&quis=purus&turpis=sit&eget=amet&elit=nulla&sodales=quisque&scelerisque=arcu&mauris=libero','Au-delà des questions géographiques, d’autres rivalités se situent dans le quotidien. Les célibataires VS les couples, qui est le plus heureux le soir de la St-Valentin? Les jeunes VS les vieux, l’énergie ou l’expérience?  ',NULL);
INSERT INTO S_evenement.tblEvenement([nom],[dateDebut],[dateFin],[affiche],[url],[description],[dateSupprime]) VALUES('Festi-rire 2011','2011/01/02','2011/11/02','http://www.webmarketing-com.com/wp-content/uploads/2015/08/evenement.jpg','http://disqus.com/neque/libero/convallis/eget/eleifend.jsp?consequat=proin&in=risus&consequat=praesent&ut=lectus&nulla=vestibulum&sed=quam&accumsan=sapien&felis=varius&ut=ut&at=blandit&dolor=non&quis=interdum&odio=in&consequat=ante&varius=vestibulum&integer=ante&ac=ipsum&leo=primis&pellentesque=in&ultrices=faucibus&mattis=orci&odio=luctus&donec=et&vitae=ultrices&nisi=posuere&nam=cubilia&ultrices=curae&libero=duis&non=faucibus&mattis=accumsan&pulvinar=odio&nulla=curabitur&pede=convallis&ullamcorper=duis&augue=consequat&a=dui&suscipit=nec&nulla=nisi&elit=volutpat&ac=eleifend&nulla=donec&sed=ut&vel=dolor&enim=morbi&sit=vel&amet=lectus&nunc=in&viverra=quam&dapibus=fringilla&nulla=rhoncus&suscipit=mauris&ligula=enim&in=leo&lacus=rhoncus&curabitur=sed&at=vestibulum&ipsum=sit&ac=amet&tellus=cursus&semper=id&interdum=turpis&mauris=integer&ullamcorper=aliquet&purus=massa&sit=id&amet=lobortis&nulla=convallis&quisque=tortor&arcu=risus&libero=dapibus&rutrum=augue&ac=vel&lobortis=accumsan&vel=tellus','Les conflits peuvent également surgir de traits de personnalités comme les esprits terre-à-terre VS les esprits éclatés, tordus, f**kés! Le pantalon corduroy beige ou le jeans rouge vif? Ou encore les personnalités cérébrales ou plutôt impulsives. On s’imagine mal Denise Bombardier flipper sa maison à grands coups de masse dans les murs! ',NULL);
INSERT INTO S_evenement.tblEvenement([nom],[dateDebut],[dateFin],[affiche],[url],[description],[dateSupprime]) VALUES('Festi-rire 2012','2012/01/02','2012/11/02','http://alter-ego.multigrafinc.netdna-cdn.com/wp-content/uploads/2014/08/organisateur-evenement-corporatif-2.jpg','http://e-recht24.de/non/interdum/in/ante/vestibulum.aspx?odio=molestie&odio=lorem&elementum=quisque&eu=ut&interdum=erat&eu=curabitur&tincidunt=gravida&in=nisi&leo=at&maecenas=nibh&pulvinar=in&lobortis=hac&est=habitasse&phasellus=platea&sit=dictumst&amet=aliquam&erat=augue&nulla=quam&tempus=sollicitudin&vivamus=vitae&in=consectetuer&felis=eget&eu=rutrum&sapien=at&cursus=lorem&vestibulum=integer&proin=tincidunt&eu=ante&mi=vel&nulla=ipsum&ac=praesent&enim=blandit&in=lacinia&tempor=erat&turpis=vestibulum&nec=sed&euismod=magna&scelerisque=at&quam=nunc&turpis=commodo&adipiscing=placerat&lorem=praesent&vitae=blandit&mattis=nam&nibh=nulla&ligula=integer&nec=pede&sem=justo&duis=lacinia&aliquam=eget&convallis=tincidunt&nunc=eget&proin=tempus&at=vel&turpis=pede&a=morbi&pede=porttitor&posuere=lorem&nonummy=id&integer=ligula&non=suspendisse&velit=ornare&donec=consequat&diam=lectus&neque=in&vestibulum=est&eget=risus&vulputate=auctor&ut=sed&ultrices=tristique&vel=in&augue=tempus&vestibulum=sit&ante=amet&ipsum=sem&primis=fusce&in=consequat','Cette année, le Galas Festi rire s’attaquent aux grandes rivalités des Québécois. Évidemment, qui dit rivalités québécoises pense immédiatement à Canadiens VS Nordiques. Non, pas de galas sur ce sujet, le but d’Alain Côté n’était pas bon, fin du débat! Mais cet esprit compétitif a même traversé l’Atlantique avec nos « chers » cousins français! Le Québec vs la France est bel et bien existant. Anne Dorval peut bien avoir pété un plomb sur un plateau de télé français!! Ils nous cherchent!  ',NULL);
INSERT INTO S_evenement.tblEvenement([nom],[dateDebut],[dateFin],[affiche],[url],[description],[dateSupprime]) VALUES('Festi-rire 2013','2013/01/02','2013/11/02','http://3.bp.blogspot.com/_21PcJQtvgB4/SdDYfE44aYI/AAAAAAAAAJA/EGYsAtoeykU/s400/Euronext5+(r2).png','https://alibaba.com/platea/dictumst/maecenas/ut/massa.html?sed=volutpat&magna=convallis&at=morbi&nunc=odio&commodo=odio&placerat=elementum&praesent=eu&blandit=interdum&nam=eu&nulla=tincidunt&integer=in&pede=leo&justo=maecenas&lacinia=pulvinar&eget=lobortis&tincidunt=est&eget=phasellus&tempus=sit&vel=amet&pede=erat&morbi=nulla&porttitor=tempus&lorem=vivamus&id=in&ligula=felis&suspendisse=eu&ornare=sapien&consequat=cursus&lectus=vestibulum&in=proin&est=eu&risus=mi&auctor=nulla&sed=ac&tristique=enim&in=in&tempus=tempor&sit=turpis&amet=nec&sem=euismod&fusce=scelerisque&consequat=quam&nulla=turpis&nisl=adipiscing&nunc=lorem&nisl=vitae&duis=mattis&bibendum=nibh&felis=ligula&sed=nec&interdum=sem&venenatis=duis&turpis=aliquam&enim=convallis&blandit=nunc&mi=proin&in=at&porttitor=turpis&pede=a&justo=pede&eu=posuere&massa=nonummy&donec=integer&dapibus=non&duis=velit&at=donec&velit=diam&eu=neque&est=vestibulum&congue=eget&elementum=vulputate&in=ut&hac=ultrices&habitasse=vel&platea=augue&dictumst=vestibulum&morbi=ante&vestibulum=ipsum&velit=primis&id=in&pretium=faucibus&iaculis=orci&diam=luctus&erat=et&fermentum=ultrices&justo=posuere&nec=cubilia&condimentum=curae&neque=donec&sapien=pharetra&placerat=magna&ante=vestibulum&nulla=aliquet&justo=ultrices&aliquam=erat&quis=tortor&turpis=sollicitudin','L''événement met en valeur le travail des artistes du secteur de l''humour en les récompensant pour leurs œuvres. Il a également pour but de faire la promotion de l''industrie humoristique, en plus de faire connaître au public les humoristes émergents, mais également les auteurs et les metteurs en scène.',NULL);
INSERT INTO S_evenement.tblEvenement([nom],[dateDebut],[dateFin],[affiche],[url],[description],[dateSupprime]) VALUES('Festi-rire 2014','2014/01/02','2014/11/02','http://en.vogue.fr/uploads/images/thumbs/201241/la_soir__e_herm__s_au_palais_brongniart_155368180_north_499x_white.jpg','https://icq.com/turpis.html?nam=accumsan&dui=odio&proin=curabitur&leo=convallis&odio=duis&porttitor=consequat&id=dui&consequat=nec&in=nisi&consequat=volutpat&ut=eleifend&nulla=donec&sed=ut&accumsan=dolor&felis=morbi&ut=vel&at=lectus&dolor=in&quis=quam&odio=fringilla&consequat=rhoncus&varius=mauris&integer=enim&ac=leo&leo=rhoncus&pellentesque=sed&ultrices=vestibulum','On a tellement ri l’an dernier qu’on le ramène pour une deuxième édition! Sous la surveillance d’Eddy King à l’animation, le Gala humour de la rentrée 2016 mettra en vedette Didier Lambert, Jay Du Temple, Étienne Dano, Charles Deschamps, Mélanie Ghanimé ainsi qu’un invité surprise. Le spectacle parfait pour bien amorcer la rentrée et commencer son expérience OUMF en beauté!',NULL);
INSERT INTO S_evenement.tblEvenement([nom],[dateDebut],[dateFin],[affiche],[url],[description],[dateSupprime]) VALUES('Festi-rire 2015','2015/01/02','2015/11/02','http://www.petitpave.fr/uploads/un-jour-un-evenement_0.jpg','https://goodreads.com/quis/tortor/id.jpg?eu=nisl&nibh=duis&quisque=ac&id=nibh&justo=fusce&sit=lacus&amet=purus&sapien=aliquet&dignissim=at&vestibulum=feugiat&vestibulum=non&ante=pretium&ipsum=quis&primis=lectus&in=suspendisse&faucibus=potenti&orci=in&luctus=eleifend&et=quam&ultrices=a&posuere=odio&cubilia=in&curae=hac&nulla=habitasse',NULL,NULL);
INSERT INTO S_evenement.tblEvenement([nom],[dateDebut],[dateFin],[affiche],[url],[description],[dateSupprime]) VALUES('Festi-rire 2016','2016/01/02','2016/11/02','http://venise-evenements.com/assets/img/prove_primaslide-03.jpg','https://topsy.com/magnis/dis.js?et=etiam&ultrices=justo&posuere=etiam&cubilia=pretium&curae=iaculis&nulla=justo&dapibus=in&dolor=hac&vel=habitasse&est=platea&donec=dictumst&odio=etiam&justo=faucibus&sollicitudin=cursus&ut=urna&suscipit=ut&a=tellus&feugiat=nulla&et=ut&eros=erat&vestibulum=id&ac=mauris&est=vulputate&lacinia=elementum&nisi=nullam&venenatis=varius&tristique=nulla&fusce=facilisi&congue=cras&diam=non&id=velit&ornare=nec&imperdiet=nisi&sapien=vulputate&urna=nonummy&pretium=maecenas&nisl=tincidunt&ut=lacus&volutpat=at&sapien=velit&arcu=vivamus&sed=vel&augue=nulla&aliquam=eget&erat=eros&volutpat=elementum&in=pellentesque&congue=quisque&etiam=porta&justo=volutpat&etiam=erat&pretium=quisque&iaculis=erat&justo=eros&in=viverra&hac=eget&habitasse=congue&platea=eget&dictumst=semper&etiam=rutrum&faucibus=nulla&cursus=nunc&urna=purus&ut=phasellus&tellus=in&nulla=felis&ut=donec&erat=semper&id=sapien&mauris=a&vulputate=libero&elementum=nam&nullam=dui&varius=proin&nulla=leo&facilisi=odio&cras=porttitor&non=id&velit=consequat&nec=in&nisi=consequat&vulputate=ut&nonummy=nulla&maecenas=sed&tincidunt=accumsan&lacus=felis&at=ut&velit=at&vivamus=dolor&vel=quis&nulla=odio&eget=consequat&eros=varius&elementum=integer&pellentesque=ac&quisque=leo&porta=pellentesque&volutpat=ultrices&erat=mattis','C’est l’occasion idéale pour vous en mettre plein la rate avec des spectacles d’humoristes, mais aussi de la variété, de la musique et plus encore.',NULL);
INSERT INTO S_evenement.tblEvenement([nom],[dateDebut],[dateFin],[affiche],[url],[description],[dateSupprime]) VALUES('Festi-rire 2018','2018/01/02','2018/11/02','http://www.larochelle-evenements.fr/uploads/media_items/logo-la-rochelle-evenements.960.800.jpg','https://wix.com/erat/eros.jpg?et=magnis&commodo=dis&vulputate=parturient&justo=montes&in=nascetur&blandit=ridiculus&ultrices=mus&enim=vivamus&lorem=vestibulum&ipsum=sagittis&dolor=sapien&sit=cum&amet=sociis&consectetuer=natoque&adipiscing=penatibus&elit=et&proin=magnis&interdum=dis&mauris=parturient&non=montes&ligula=nascetur&pellentesque=ridiculus&ultrices=mus&phasellus=etiam&id=vel&sapien=augue&in=vestibulum&sapien=rutrum&iaculis=rutrum&congue=neque&vivamus=aenean&metus=auctor&arcu=gravida&adipiscing=sem&molestie=praesent&hendrerit=id&at=massa&vulputate=id&vitae=nisl&nisl=venenatis&aenean=lacinia&lectus=aenean&pellentesque=sit&eget=amet&nunc=justo&donec=morbi&quis=ut&orci=odio&eget=cras&orci=mi&vehicula=pede&condimentum=malesuada&curabitur=in&in=imperdiet&libero=et&ut=commodo&massa=vulputate&volutpat=justo&convallis=in&morbi=blandit&odio=ultrices&odio=enim','Année après année, la Tournée des finissants de l’École nationale de l’humour permet aux Québécois de faire la connaissance des nouveaux visages de l’humour avant tout le monde!',NULL);
INSERT INTO S_evenement.tblEvenement([nom],[dateDebut],[dateFin],[affiche],[url],[description],[dateSupprime]) VALUES('Festi-rire 2019','2019/01/02','2019/11/02',NULL,NULL,'La 15ème édition du Festival aura lieu cette année du 2 janvier au 2 novembre 2019. 17 spectacle seront à l’affiche dans le département de l’Eure- et-Loir. Les villes partenaires du festival sont cette année : Chartres, Mainvilliers, Luisant, Lucé, Gasville-Oisème, Cloyes-sur-le- Loir, Auneau, Epernon, Dreux, Anet et Thivars.',NULL);
INSERT INTO S_evenement.tblEvenement([nom],[dateDebut],[dateFin],[affiche],[url],[description],[dateSupprime]) VALUES('Festi-rire 2009','2009/01/02','2009/11/02',NULL,NULL,NULL,NULL);

GO

PRINT('Fin des insertions des évènements')

GO

PRINT('Début des insertions de la table des sous-évènements')
...
INSERT INTO S_evenement.tblSousEvenement([nom],[description],[dateSupprime],[noEvenement]) VALUES('Spectacle 2012','montes, nascetur',NULL,3);
INSERT INTO S_evenement.tblSousEvenement([nom],[description],[dateSupprime],[noEvenement]) VALUES('Spectacle 2010','eu lacus. Quisque imperdiet, erat nonummy ultricies ornare, elit elit fermentum',NULL,1);
INSERT INTO S_evenement.tblSousEvenement([nom],[description],[dateSupprime],[noEvenement]) VALUES('Spectacle 2014','pede et risus. Quisque libero lacus, varius et, euismod et, commodo at, libero. Morbi accumsan laoreet ipsum. Curabitur consequat, lectus',NULL,5);
INSERT INTO S_evenement.tblSousEvenement([nom],[description],[dateSupprime],[noEvenement]) VALUES('Spectacle 2018','ligula. Aenean euismod mauris eu elit. Nulla','2013/11/08',9);
INSERT INTO S_evenement.tblSousEvenement([nom],[description],[dateSupprime],[noEvenement]) VALUES('Souper 2014','ligula. Aenean gravida nunc sed pede. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Proin vel arcu eu odio tristique pharetra. Quisque ac libero nec ligula consectetuer rhoncus. Nullam velit dui, semper et, lacinia vitae, sodales',NULL,5);
INSERT INTO S_evenement.tblSousEvenement([nom],[description],[dateSupprime],[noEvenement]) VALUES('Souper 2018','mi pede, nonummy ut, molestie in, tempus eu, ligula. Aenean euismod mauris eu elit. Nulla facilisi. Sed','2013/11/14',9);
INSERT INTO S_evenement.tblSousEvenement([nom],[description],[dateSupprime],[noEvenement]) VALUES('Collecte de fond 2019','dolor. Fusce mi lorem, vehicula et,','2014/04/08',9);
INSERT INTO S_evenement.tblSousEvenement([nom],[description],[dateSupprime],[noEvenement]) VALUES('Collecte de fond 2014','Aenean euismod mauris eu elit. Nulla facilisi. Sed neque. Sed eget lacus. Mauris non dui nec urna suscipit nonummy. Fusce fermentum fermentum arcu. Vestibulum ante ipsum primis in',NULL,5);
...
PRINT('Début des insertions de la table des activités')

GO

INSERT INTO S_evenement.tblActivite([nomResponsable],[etat],[dateCreation],[tache],[detail],[dateSupprime],[noEvenement],[noSousEvenement]) VALUES('Mia Glenn','0','2015/03/05','Contacter NRJ','Doit contacter NRJ pour obtenir des commandites',NULL,NULL,10);
INSERT INTO S_evenement.tblActivite([nomResponsable],[etat],[dateCreation],[tache],[detail],[dateSupprime],[noEvenement],[noSousEvenement]) VALUES('Brooke Austin','0','2013/11/22','Faire imprimer les affiches','Doit imprimer les affiche en 8 1/2 x 14 po afin de les donner aux directeurs',NULL,10,NULL);
INSERT INTO S_evenement.tblActivite([nomResponsable],[etat],[dateCreation],[tache],[detail],[dateSupprime],[noEvenement],[noSousEvenement]) VALUES('Athena Hebert','1','2015/06/20','Commander du manger','Lors du prochain spectacle, doit commander du manger pour 800 personnes aux restaurant St-Hubert',NULL,NULL,13);
INSERT INTO S_evenement.tblActivite([nomResponsable],[etat],[dateCreation],[tache],[detail],[dateSupprime],[noEvenement],[noSousEvenement]) VALUES('Ariel Blackwell','1','2014/01/05','Contacter Radio-Canada','Contacter Radio-Canada afin qu''ils publient la publicité',NULL,2,NULL);
INSERT INTO S_evenement.tblActivite([nomResponsable],[etat],[dateCreation],[tache],[detail],[dateSupprime],[noEvenement],[noSousEvenement]) VALUES('Doris Dillon','1','2015/02/16','Préparer la salle','Doit faire  les préparatifs nécéssaire afin de préparer la salle pour le spectacle',NULL,5,NULL);
INSERT INTO S_evenement.tblActivite([nomResponsable],[etat],[dateCreation],[tache],[detail],[dateSupprime],[noEvenement],[noSousEvenement]) VALUES('Cameran Meyers','0','2014/11/11','Contacter Anne Dorval','Doit appeller Anne Dorval pour savoir si elle peut se présenter au spectacle',NULL,NULL,1);
...
PRINT('Fin des insertions des activités')

GO

PRINT('Début des insertions de la table des Commanditaires')
...
INSERT INTO S_evenement.tblCommanditaire([nomCommanditaire],[nomContact],[logo],[url],[textePresentation],[courrielContact],[numTel],[extension],[dateSupprime]) VALUES('Bibendum Sed Est Institute','Charlotte Burke',NULL,NULL,'congue a, aliquet vel, vulputate','pado.fro@sagittisplaceratCras.edu','7743522111','20314',NULL);
...
PRINT('Ajout de FK dans la table engagement')

GO

UPDATE S_Contrat.tblEngagement SET noSousEvenement = ABS(1 + ((CAST(ABS(CHECKSUM(NEWID())) % 101 AS FLOAT) / 100) * 14)) WHERE noEngagement IN
(
    SELECT TOP 75 PERCENT noEngagement from S_Contrat.tblEngagement ORDER BY NEWID()
)

GO
PRINT('Fin de l''ajout de FK dans la table engagement')
GO 
