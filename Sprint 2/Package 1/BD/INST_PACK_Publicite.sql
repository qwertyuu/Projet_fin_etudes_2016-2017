...
INSERT INTO S_publicite.tblAppelOffre([nom],[dateEnvoi],[dateRequis],[description],[noEvenement],[noStatut],noMedia) VALUES('Concours pour gagner des billets graduits','2016-03-29 14:31:19','2015-04-13 10:05:17','concours en vedette et courer la chnace de gagner des billets graduits',6,1,3);
...
INSERT INTO S_publicite.tblSoumission(noSoumissionAgence,prix,statut,commentaire,dateSupprime,[noAgencePub],[noAppelOffre]) VALUES(NULL, 90.05,null,'leo. Vivamus nibh dolor, nonummy ac, feugiat non, lobortis quis, pede. Suspendisse dui. Fusce diam nunc, ullamcorper eu, euismod ac, fermentum vel, mauris. Integer sem',NULL,5,10);
...
INSERT INTO S_publicite.tblSoumission(noSoumissionAgence,prix,statut,commentaire,dateSupprime,[noAgencePub],[noAppelOffre])  VALUES(NULL,199.90,null,'dictum sapien. Aenean massa. Integer vitae',NULL,10,1);
...
INSERT INTO S_publicite.tblSoumission(noSoumissionAgence,prix,statut,commentaire,dateSupprime,[noAgencePub],[noAppelOffre]) VALUES(NULL,540.94,null,'Cette soumission permet de faire la publicité du spectacle du feu auprès des agences de publicité et elle doit être répondu le plutôt posiblle',NULL,3,4);
...
INSERT INTO S_publicite.tblSoumission(noSoumissionAgence,prix,statut,commentaire,dateSupprime,[noAgencePub],[noAppelOffre]) VALUES(NULL,1000.79,null,'suscipit nonummy. Fusce fermentum fermentum arcu. Vestibulum',NULL,2,3);
...
INSERT INTO S_publicite.tblSoumission(noSoumissionAgence,prix,statut,commentaire, dateSupprime,[noAgencePub],[noAppelOffre])  VALUES('JOURQC',454.88,0,'Integer sem elit, pharetra ut, pharetra sed, hendrerit a, arcu. Sed et libero. Proin mi. Aliquam gravida mauris ut mi. Duis risus odio, auctor vitae',null,33,1);
INSERT INTO S_publicite.tblSoumission(noSoumissionAgence,prix,statut,commentaire,dateSupprime,[noAgencePub],[noAppelOffre]) VALUES('JIMES&JAN',390.79,0,'scelerisque scelerisque dui. Suspendisse ac metus vitae velit egestas lacinia. Sed congue, elit sed consequat auctor, nunc nulla vulputate dui, nec tempus mauris erat eget',NULL,10,1);
