...
INSERT INTO S_publicite.tblStatutAppelOffre(nom,couleur,description)VALUES('Annulé','4B0082','L''appel d''offre est annulé')
...
GO
INSERT INTO S_publicite.tblAppelOffre([nom],[dateEnvoi],[dateRequis],[description],[noEvenement],[noStatut],noMedia) VALUES('Promotion sur les billets de spectacle','2016-04-05 17:07:42','2016-05-19 20:23:45','Cette publicité est faitre pour promouvoir les promotions et les rabais sur les billlets des spectacles.',1,3,1);
...
INSERT INTO S_publicite.tblAppelOffre([nom],[dateEnvoi],[dateRequis],[description],[noEvenement],[noStatut],noMedia) VALUES('Spectacle en feu','2016-08-29 11:45:41','2017-04-25 16:34:29','Repésente de spectacle de clôture',3,3,4);
...
INSERT INTO S_publicite.tblAppelOffre([nom],[dateEnvoi],[dateRequis],[description],[noEvenement],[noStatut],noMedia) VALUES('Promotion des places','2016-07-09 14:09:06','2016-11-14 08:19:39','Faire la publicité sur differentes places',7,4,5);
...
INSERT INTO S_publicite.tblAppelOffre([nom],[dateEnvoi],[dateRequis],[description],[noEvenement],[noStatut],noMedia) VALUES('Publicité du souper de fin de spectacle','2016-03-20 21:22:45','2016-12-01 18:52:02','Faire la publicité de l''évènement',8,2,2);
INSERT INTO S_publicite.tblAppelOffre([nom],[dateEnvoi],[dateRequis],description, [noEvenement],[noStatut],noMedia) VALUES('Promotions des auberges','2016-12-12 23:45:29','2017-01-11 21:47:20','Cette publicité rend compte des prix et rabais des auberges',8,1,1);
INSERT INTO S_publicite.tblAppelOffre([nom],[dateEnvoi],[dateRequis],description, [noEvenement],[noStatut],noMedia) VALUES('Promtion des places de spectacles','2016-12-24 15:45:29','2017-06-11 21:47:20','Cette publicité fait la promotion des bonnes places du spectacle',3,2,3);
INSERT INTO S_publicite.tblAppelOffre([nom],[dateEnvoi],[dateRequis],description, [noEvenement],[noStatut],noMedia) VALUES('Publicité de début de spectacle','2016-12-24 12:45:29','2017-03-11 16:47:00','Cette publicité fait la promotion des bonnes places du spectacle',4,1,3);
PRINT 'Fin d''insertion de table tblAppelOffre'

GO
INSERT INTO S_publicite.tblSoumission(noSoumissionAgence,prix,statut,commentaire,dateEnvoi,dateReponse,dateSupprime,[noAgencePub],[noAppelOffre]) VALUES(NULL,87.74,1,'Cette soumission permet de faire la promotion billets  de spectacle auprès des agences de publicité et elle doit être répondu le plutôt posiblle','2016-04-05 17:07:42','2016-08-05 19:07:42',NULL,4,1);
...
INSERT INTO S_publicite.tblSoumission(noSoumissionAgence,prix,statut,commentaire,dateEnvoi,dateReponse,dateSupprime,[noAgencePub],[noAppelOffre]) VALUES(NULL,540.94,1,'Cette soumission permet de faire la publicité de l''humoriste de l''année auprès des agences de publicité et elle doit être répondu le plutôt posiblle','2016-07-03 09:21:11',NULL,NULL,3,4);
